...
\right)
\end{eqnarray}
Since the CCF definition involves delta-functions, some smoothing is necessary
to display the stacked CCF. In Figure~\ref{fig:ccf},
we show the stacked CCF from the 100 simulated AGN data sets, plotted as a
histogram (the nonzero bin width provides the smoothing).
